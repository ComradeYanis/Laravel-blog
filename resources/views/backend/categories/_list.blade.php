<table class="table table-striped table-sm table-responsive-md">
    ...
    @foreach($categories as $category)
        <tr>
            ...
            <td><span class="badge badge-pill badge-secondary">{{ $category->comments_count }}</span></td>
            <td>
                <a href="{{ route('backend.categories.edit', $category) }}" class="btn btn-primary btn-sm">
                    <i class="fa fa-pencil" aria-hidden="true"></i>
                </a>

                {!! Form::model($category, ['method' => 'DELETE', 'route' => ['backend.categories.destroy', $category], 'class' => 'form-inline', 'data-confirm' => __('forms.categories.delete')]) !!}
